...
def parse_opt():
    ...
    #parser.add_argument("--textListFile",   type=str, default='datasets/kaist-rgbt/train-all-04.txt',         help="Text file containing image file names (e.g., train-all-04.txt)")
    ...
    parser.add_argument("--jsonAnnFile",    type=str, default='utils/eval/KAIST_annotation.json',           help="Output json filename")
